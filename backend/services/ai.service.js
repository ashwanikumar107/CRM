...
//   if (PROVIDER === 'gemini') {
//     return chatGemini(systemPrompt, userPrompt, jsonMode);
//   }
//   return chatOpenAI(systemPrompt, userPrompt, jsonMode);
// }

// async function chatOpenAI(systemPrompt, userPrompt, jsonMode) {
...
// async function chatGemini(systemPrompt, userPrompt, jsonMode) {
